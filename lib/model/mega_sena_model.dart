...
MegaSenaModel modelMegaSenaFromJson(String str) => MegaSenaModel.fromJson(json.decode(str));
...
class MegaSenaModel {
    ...
    final int valorSaldoReservaGarantidora;
    final int valorTotalPremioFaixaUm;
    ...
    MegaSenaModel copyWith({
        ...
        int? valorEstimadoProximoConcurso,
        int? valorSaldoReservaGarantidora,
        int? valorTotalPremioFaixaUm,
    }) => 
        MegaSenaModel(
            ...
            dezenasSorteadasOrdemSorteio: dezenasSorteadasOrdemSorteio ?? this.dezenasSorteadasOrdemSorteio,
            exibirDetalhamentoPorCidade: exibirDetalhamentoPorCidade ?? this.exibirDetalhamentoPorCidade,
            id: id ?? this.id,
            indicadorConcursoEspecial: indicadorConcursoEspecial ?? this.indicadorConcursoEspecial,
            listaDezenas: listaDezenas ?? this.listaDezenas,
            listaDezenasSegundoSorteio: listaDezenasSegundoSorteio ?? this.listaDezenasSegundoSorteio,
            listaMunicipioUfGanhadores: listaMunicipioUfGanhadores ?? this.listaMunicipioUfGanhadores,
            listaRateioPremio: listaRateioPremio ?? this.listaRateioPremio,
            listaResultadoEquipeEsportiva: listaResultadoEquipeEsportiva ?? this.listaResultadoEquipeEsportiva,
            localSorteio: localSorteio ?? this.localSorteio,
            nomeMunicipioUfSorteio: nomeMunicipioUfSorteio ?? this.nomeMunicipioUfSorteio,
            nomeTimeCoracaoMesSorte: nomeTimeCoracaoMesSorte ?? this.nomeTimeCoracaoMesSorte,
            numero: numero ?? this.numero,
            numeroConcursoAnterior: numeroConcursoAnterior ?? this.numeroConcursoAnterior,
            numeroConcursoFinal05: numeroConcursoFinal05 ?? this.numeroConcursoFinal05,
            numeroConcursoProximo: numeroConcursoProximo ?? this.numeroConcursoProximo,
            numeroJogo: numeroJogo ?? this.numeroJogo,
            observacao: observacao ?? this.observacao,
            premiacaoContingencia: premiacaoContingencia ?? this.premiacaoContingencia,
            ...
            valorSaldoReservaGarantidora: valorSaldoReservaGarantidora ?? this.valorSaldoReservaGarantidora,
            valorTotalPremioFaixaUm: valorTotalPremioFaixaUm ?? this.valorTotalPremioFaixaUm,
        );
    ...
    factory MegaSenaModel.fromJson(Map<String, dynamic> json) => MegaSenaModel(
        ...
        dezenasSorteadasOrdemSorteio: List<String>.from(json["dezenasSorteadasOrdemSorteio"].map((x) => x)),
        ...
        listaMunicipioUfGanhadores: List<dynamic>.from(json["listaMunicipioUFGanhadores"].map((x) => x)),
        listaRateioPremio: List<ListaRateioPremio>.from(json["listaRateioPremio"].map((x) => ListaRateioPremio.fromJson(x))),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "dezenasSorteadasOrdemSorteio": List<dynamic>.from(dezenasSorteadasOrdemSorteio.map((x) => x)),
        ...
        "listaMunicipioUFGanhadores": List<dynamic>.from(listaMunicipioUfGanhadores.map((x) => x)),
        "listaRateioPremio": List<dynamic>.from(listaRateioPremio.map((x) => x.toJson())),
...
class ListaRateioPremio {
    ...
    factory ListaRateioPremio.fromJson(Map<String, dynamic> json) => ListaRateioPremio(
